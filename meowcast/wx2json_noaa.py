...
class meowcast(object):
    ...
    def __init__(self, location):
        ...
        meowcast   = "<h1>"+self.meowplace+"<br> <small>is</small> "+self.meowobs+" <small>and</small> "\
    ...
    def persist():
        ...
        """ Probably makes sense to
            ...
            This means, need to develop
                1. a Db schema for meowcast
                2. functions to write/read from schema
                3. probably some auto refresh for known locations, to keep the responses faster for all the mega fans of meowcast
